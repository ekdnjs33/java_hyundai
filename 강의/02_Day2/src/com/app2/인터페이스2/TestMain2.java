...
public class TestMain2 {
	public static void main(String[] args) {
		 ...
		 *      - 구성요소 4가지
		 *         가. 인스턴스변수,생성자,인스턴스메서드 ==> 일반클래스 요소
		 *         나. 추상메서드(abstract)
		 *      - 특징
		 *         : new 불가(객체생성 불가) 
		 *         : 임의의 클래스 이용해서 추상클래스 요소 사용된다.
		 *           ==> 임의의 클래스와 추상클래스는 상속관계로서 extends 사용한다.(단일상속만 지원)
		 *      - 목적
		 *         : 하위 클래스에서 특정 메서드만 사용하도록 강제 + 일반클래스의 상속(공통기능재사용) 장점 제공    
		 *         
		 *      - 단점
		 *         : 다른 클래스를 상속 불가
		 *            
		 ...
		 *      - 구성요소 4가지
		 *         가. 상수, 추상메서드, default 메서드, static 메서드
		 *      - 특징
		 *         : new 불가(객체생성 불가) 
